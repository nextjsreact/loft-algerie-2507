  ...
  return measurePerformance(async () => {
    ...
    try {
      ...
      for (const task of dueTasks || []) {
        const title = `Maintenance Due - ${task.loft?.name}`
